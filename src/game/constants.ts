...
export const DAILY_RESET_HOUR_LOCAL = 4;
export const DAY_MS = 24 * 60 * 60 * 1000;
export const FOCUS_MAX = 200;
export const FOCUS_REGEN_INTERVAL_MS = 15 * 60 * 1000;
export const FOCUS_EXPEDITION_BOOST_COST = 20;
export const FOCUS_EXPEDITION_BOOST_MULTIPLIER = 2;
